...
export default {
    data() {
        let option: Option = {
            ...
            url: 'https://live-vps4.b11p.com/live/guahuang.flv',
            // type: "mpegts",
            // theme: "#",
            isLive: true,
            autoplay: false,
            ...
            quality: [
                ...
                {
                    html: 'IPv4+IPv6',
                    url: 'https://live-vps.b11p.com/live/guahuang.flv',
                },
                {
                    html: 'Cloudflare',
                    url: 'https://live-vps-cf.b11p.com/live/guahuang.flv',
                },
                {
                    html: "HLS (iOS 兼容)",
                    url: "https://live-vps4.b11p.com/live/guahuang.m3u8",
                },
                {
                    html: "HLS + 双栈",
                    url: "https://live-vps.b11p.com/live/guahuang.m3u8",
                },
            ],
        };
        return {
            ...
            danmakuOption: {
                group: "dbb3e415-750a-43a1-a678-30d542d8f916",
