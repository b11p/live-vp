...
export default {
    data() {
        let option: Option = {
            ...
            url: 'https://live-vps4.b11p.com/live/sumimi.flv',
            // type: "mpegts",
            theme: "#fff4dc",
            isLive: true,
            autoplay: false,
            ...
            quality: [
                ...
                {
                    html: 'IPv4+IPv6',
                    url: 'https://live-vps.b11p.com/live/sumimi.flv',
                },
                {
                    html: 'Cloudflare',
                    url: 'https://live-vps-cf.b11p.com/live/sumimi.flv',
                },
                {
                    html: "HLS (iOS 兼容)",
                    url: "https://live-vps4.b11p.com/live/sumimi.m3u8",
                },
                {
                    html: "HLS + 双栈",
                    url: "https://live-vps.b11p.com/live/sumimi.m3u8",
                },
            ],
        };
        return {
            ...
            danmakuOption: {
                group: "042ec06c-f2a1-4a04-adca-42ba3536293f",
